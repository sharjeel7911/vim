...
This motivated me to **implement a from-scratch, performant Gap Buffer in C++** — not just as an academic exercise, but as a **potential open-source contribution**. The result is a this implementation for my obsessive mind
